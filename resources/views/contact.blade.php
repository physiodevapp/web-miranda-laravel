<x-miranda-layout>
  <main class="contact">
    ...
    <form id="contact-form" class="contact__form" action="">
      <input class="contact__form__name" type="text" name="" id="" placeholder="Your full name" style="background-image: url('./assets/images/392531_account_friend_human_man_member_icon\ 1 (1).svg');">
      <input class="contact__form__phone" type="number" name="" id="" placeholder="Add phone number" style="background-image: url('./assets/images/2703069_phone_cell_contact_telephone_icon\ 1.svg');">
      <input class="contact__form__email" type="email" name="" id="" placeholder="Enter email address" style="background-image: url('./assets/images/1904660_email_envelope_letter_mail_message_icon\ 1.svg');">
      <input class="contact__form__subject" type="text" name="" id="" placeholder="Enter subject" style="background-image: url('./assets/images/svg-gobbler\ -\ 2022-03-03T212453.252\ 2.svg');">
      <textarea name="" id="" placeholder="Enter message" rows="4" style="background-image: url('./assets/images/622400_pen_pencil_edit_write_writing_icon\ 1.svg');"></textarea>
