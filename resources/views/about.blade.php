<x-miranda-layout>
  <main class="about">
    <section class="about__history">
      ...
      <h4 class="about__history__introduction">Hello. Our hotel has been present for over 20 years. We make the best for all our customers.</h4>
    </section>
    <section class="about__services">
      <ul class="about__services__list">
        <li class="about__services__list__item">
          <svg width="60" height="51" viewBox="0 0 60 51" fill="none" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
            <rect x="0.685486" y="0.450195" width="58.46" height="50.56" fill="url(#pattern0_54_1226)"/>
            <defs>
            <pattern id="pattern0_54_1226" patternContentUnits="objectBoundingBox" width="1" height="1">
          ...
          <h6 class="item__title">Breakfast</h6>
        </li>
        <li class="about__services__list__item about__services__list__item--secondary">
        ...
        <li class="about__services__list__item">
          ...
          <h6 class="item__title">Luxury Room</h6>
        </li>
      </ul>
    </section>
    <section class="about__restaurant">
      <figure class="about__restaurant__image">
        <img src="/images/photo_1718991070525.jpg" alt="">
      </figure>
      <div class="about__restaurant__info">
        <h6 class="about__restaurant__info__subtitle">Restaurant</h6>
        <h4 class="about__restaurant__info__title">Get Restaurant Facilities & Many Other More</h4>
        <p class="about__restaurant__info__description">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tem por incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip.</p>
        <button class="about__restaurant__info__button">Take a tour</button>
      </div>
    </section>
    <section class="about__facilities"> 
      <h6 class="about__facilities__subtitle">Facilities</h6>
      <h4 class="about__facilities__title">Core Features</h4>
      <div class="swiper about__facilities__slider">
    ...
    <section class="about__facts">
      <h6 class="about__facts__subtitle">Counter</h6>
      <h4 class="about__facts__title">Some Fun Facts</h4>
      <ul class="about__facts__list">
        <li class="about__facts__list__item">
          <img class="facts__list__item__image" src="/images/svg-gobbler - 2022-03-03T162637.580 1.svg" alt="">
          <div class="facts__list__item__wrapper">
            <h4 class="facts__list__item__wrapper__title">8000</h4>
            <h6 class="facts__list__item__wrapper__subtitle">Happy Users</h6>
          </div>
        </li>
        <li class="about__facts__list__item">
          <img class="facts__list__item__image" src="/images/svg-gobbler - 2022-03-03T162713.643 1.svg" alt="">
          <div class="facts__list__item__wrapper">
            <h4 class="facts__list__item__wrapper__title">10M</h4>
            <h6 class="facts__list__item__wrapper__subtitle">Reviews & Appriciate</h6>
          </div>
        </li>
        <li class="about__facts__list__item">
          <img class="facts__list__item__image" src="/images/svg-gobbler - 2022-03-03T162519.735 1.svg" alt="">
          <div class="facts__list__item__wrapper">
            <h4 class="facts__list__item__wrapper__title">100</h4>
            <h6 class="facts__list__item__wrapper__subtitle">Country Coverage</h6>
          </div>
        </li>
      </ul>
      <div class="swiper about__facts__slider">
        <div class="swiper-wrapper">
          <div class="swiper-slide">
            <article class="facts__slider">
              <figure class="facts__slider__image">
                <img src="/images/photo_1718991922342.jpg" alt="" />
              </figure>
            </article>
          </div>
          <div class="swiper-slide">
            <article class="facts__slider">
              <figure class="facts__slider__image">
                <img src="/images/photo_1718992262875.jpg" alt="" />
              </figure>
            </article>
          </div>
        </div> 
